		...
		<div class="sel-con">
			...
			<div class="boxx" style="margin-left: 250px;">
			  <div class="selectBox2" style="border-left: none;">
				<button class="label">사업부 소개<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 75px; transition: transform 0.3s;"></button>
...
<div>
	<div class="at-container">
		<div class="hi-title">사업부 소개</div>
	</div>
	<div class="mid-imag">&nbsp;</div>
	<div class="at-container">
		...
		<div class="hi-bt-con">
			...
			<div class="hi-bt-text" style="padding-bottom: 50px;">
