		...
		<div class="sel-con">
			...
			<div class="boxx" style="margin-left: 250px;">
			  <div class="selectBox2" style="border-left: none;">
				<button class="label">태주공장<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 90px; transition: transform 0.3s;"></button>
...
<div>
	<div class="at-container">
		<div class="hi-title" style="float: left;">태주공장</div>
		<div class="mt-title">
			<div class="mt-title-content-sub">In Wheel Motor를 주력생산하고 있으며,</br>중국시장의 전기차용 모터사업 진출을 위한 내부 인프라가 확충 되어있습니다.</div>
		</div>
		<div class="video-center">
			<a href="https://youtu.be/ocvJS0QrK2A" target="_blank"><img src="http://www.koh-a.com/img/m5_video.jpg" style="width:100%"></a>
		</div>
			...
			<div class="img-con-top">
				<div class="img-con">
					<div class="padding-first">
						<img src="<?php echo G5_IMG_URL ?>/pac3-1.png" style="float:left;">
						<div class="pac1-title">5<p style="float: right; font-size: 18px; font-weight: bold; margin-top: 12px; margin-left: 7px;">대</p></div>
						<div class="pac1-title-sub">고속프레스(200~300 Ton)</div>
					</div>
				</div>
				<div class="img-con">
					<div class="padding-first">
						<img src="<?php echo G5_IMG_URL ?>/pac3-2.png" style="float:left;">
			...
			<div class="img-con-top">
				<div class="img-con">
					<div class="padding-first" style="margin-left: -55px;">
						<img src="<?php echo G5_IMG_URL ?>/pac3-4.png" style="float:left;">
						<div class="pac1-title">1<p style="float: right; font-size: 18px; font-weight: bold; margin-top: 12px; margin-left: 7px;">Line</p></div>
						<div class="pac1-title-sub">Rotor Assembly Line</div>
					</div>
				</div>
				<div class="img-con">
					<div class="padding-first" style="margin-left: 30px;">
						<img src="<?php echo G5_IMG_URL ?>/pac3-5.png" style="float:left;">
						<div class="pac1-title">1<p style="float: right; font-size: 18px; font-weight: bold; margin-top: 12px; margin-left: 7px;">Line</p></div>
						<div class="pac1-title-sub">Bobbin 사출 Line</div>
					</div>
				</div>
				<div class="img-con">
					<div class="padding-first" style="margin-left: 30px;">
						<img src="<?php echo G5_IMG_URL ?>/pac3-6.png" style="float:left;">
						<div class="pac1-title">1<p style="float: right; font-size: 18px; font-weight: bold; margin-top: 12px; margin-left: 7px;">Line</p></div>
						<div class="pac1-title-sub">리니어 Stator Line</div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="pac1-foot-bg">
		<div class="at-container">
			...
			<div class="foot-box-con">
				...
				<div class="box-sub-title">일원화된 생산공정</div>
				<div class="box-content">모터용 코어원소재 가곡이외에 모터코어</br>타발에서 Casting,열처리,스테이터 조립까지의</br>일원화된 생산공정을 보유</div>
			</div>
			<div class="foot-box-con" style="margin-left: 5%;">
				...
				<div class="box-sub-title">안정된 생산능력</div>
				<div class="box-content">균일한 품질 유지와</br>안정된 생산능력 확보</div>
			</div>
			<div class="foot-box-con" style="margin-left: 5%;">
				...
				<div class="box-sub-title">빠른 신공법 적용</div>
				<div class="box-content">한국의성사업부문과 모터코어 생산의</br>동일한 플랫폼을 가지고 있어</br>한국 신공법의 빠른 적용 가능</div>
			</div>
		</div>
	</div>
</div>
