		...
		<div class="sel-con">
			...
			<div class="boxx" style="margin-left: 250px;">
			  <div class="selectBox2" style="border-left: none;">
				<button class="label">비전<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 115px; transition: transform 0.3s;"></button>
