		...
		<div class="sel-con">
			<div class="boxx" style="margin-left: 50px;">
			  <div class="selectBox2 ">
				<button class="label">고객지원<img src="<?php echo G5_IMG_URL?>/under_ang_b.png" style="margin-left: 85px;"></button>
				<ul class="optionList">
			...
			<div class="boxx" style="margin-left: 250px;">
			  <div class="selectBox2" style="border-left: none;">
				<button class="label">온라인 문의<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 75px;"></button>
