		...
		<div class="sel-con">
			<div class="boxx" style="margin-left: 50px;">
			  <div class="selectBox2 ">
				<button class="label">뉴스룸<img src="<?php echo G5_IMG_URL?>/under_ang_b.png" style="margin-left: 85px;"></button>
				<ul class="optionList">
			...
			<div class="boxx" style="margin-left: 250px;">
			  <div class="selectBox2" style="border-left: none;">
				<button class="label">미디어룸<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 75px;"></button>
				<ul class="optionList">
