	...
	<div class="row at-row">
		...
		<div class="col-md-9<?php echo ($side == "left") ? ' pull-right' : '';?> at-col at-main">
			...
			<div class="widget-box widget-img">
				<a href="https://namu.wiki/w/%EB%A7%88%EB%A6%AC%EC%98%A4%20%EC%8B%9C%EB%A6%AC%EC%A6%88" target="_blank">
					<img src="<?php echo THEMA_URL;?>/main/img/center_banner1.jpg">
				</a>
			</div>
			<!-- 이미지 배너 끝 -->	
		...
		<div class="col-md-3<?php echo ($side == "left") ? ' pull-left' : '';?> at-col at-side">
			...
			<div class="widget-box">
				<div style="width:100%; min-height:280px; line-height:280px; text-align:center;">
					<img src="<?php echo THEMA_URL;?>/main/img/sub_img12.jpg" style="border-radius: 25px;">
				</div>
			</div>
			<!-- 광고 끝 -->
