	...
	<div class="nav-visible">
		<div class="at-container">
			<div class="nav-top nav-float nav-slide">
				<div style="float:left; padding-top: 30px;"><a href="http://sungtaek13.dothome.co.kr"><img src="http://www.koh-a.com/img/logo_pc2_ko.png" id="logo-imga"></a></div>
				<ul class="menu-ul">
		...
		<a href="http://sungtaek12.dothome.co.kr" target="_blank"><div style="top: 3.4rem; right: 100px; position: absolute;"><img src="<?php echo G5_IMG_URL ?>/btn_koa_kor.png"></div></a>
	</div><!-- .nav-visible -->
