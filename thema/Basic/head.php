...
<script>
	$(document).ready(function(){
      $(window).scroll(function(){
        ...
        if (scroll > 200) {
          $(".pc-menu").css("background" , "rgb(255, 255, 255)");
        }
        else{
          $(".pc-menu").css("background" , "rgba(30, 30, 30, 0.5)");
        }
      })
    })
</script>
<script>
	$(document).ready(function(){
      $(window).scroll(function(){
        var scroll = $(window).scrollTop();
        if (scroll > 200) {
          $(".pc-menu .nav-top .menu-a").css("color" , "#000");
        }
        else{
          $(".pc-menu .nav-top .menu-a").css("color" , "#fff");
        }
      })
    })
</script>
<script>
	$(document).ready(function(){
      $(window).scroll(function(){
        var scroll = $(window).scrollTop();
        if (scroll > 200) {
          document.getElementById("logo-imga").src = "http://www.koh-a.com/img/logo_pc_ko.png";
        }
        else{
          document.getElementById("logo-imga").src = "http://www.koh-a.com/img/logo_pc2_ko.png";
        }
      })
    })
</script>
	...
	<header class="pc-header">
		<div class="at-container">
			<!--<div class="hidden-sm hidden-xs left-banner">
				<a href="https://www.mma.go.kr/index.do" target="_blank"><img src="<?php echo THEMA_URL;?>./assets/img/free1.jpg"></a>
			</div>
			<div class="hidden-sm hidden-xs right-banner">
				<a href="https://bj.afreecatv.com/y1026" target="_blank"><img src="<?php echo THEMA_URL;?>./assets/img/free2.jpg"></a>
			</div>-->
			<!-- PC Logo -->
			<!--<div class="header-logo">
				<a href="<?php echo $at_href['home'];?>" style="color:#fff">
					TEST_AMINA
				</a>
			</div>
			<!-- PC Search -->
	...
	<!-- Menu -->
	<nav class="at-menu" style="position: fixed; width: 100%; z-index: 3;">
		<!-- PC Menu -->
		<div class="pc-menu">
